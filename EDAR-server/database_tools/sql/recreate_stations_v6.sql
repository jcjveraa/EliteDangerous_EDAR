...
CREATE TABLE IF NOT EXISTS `stations_v6`  (id INTEGER, system_id INTEGER, max_landing_pad_size TEXT, distance_to_star INTEGER, name TEXT, full_json TEXT, 	PRIMARY KEY(`id`));
