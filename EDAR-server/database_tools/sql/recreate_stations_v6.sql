...
CREATE TABLE IF NOT EXISTS `stations_v6`  (id INTEGER, system_id INTEGER, max_landing_pad_size INTEGER, distance_to_star INTEGER, name TEXT, is_planetary INTEGER, full_json TEXT, 	PRIMARY KEY(`id`));
